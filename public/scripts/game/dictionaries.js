...
let spellbook = {
  ...
  firekey:
    ["Ключ огня", 1, 1, "(огонь, диспел) Снимает с противника баф воды или земли. Не забудьте выбрать цель."],
  fireflow:
  ...
  watersource:
    ["Родник", 1, 1, "(вода, диспел) Позволяет снять дебаф огня, воды, земли или воздуха с вероятностью 66%. Не забудьте выбрать цель."],
  watersphere:
  ...
  waterkey:
    ["Ключ воды", 1, 1, "(вода, диспел) Позволяет снять дебаф огня или воздуха. Не забудьте выбрать цель."],
  waterflow:
  ...
  earthkey:
    ["Ключ земли", 1, 1, "(земля, диспел) Позволяет снять дебаф огня или воздуха. Не забудьте выбрать цель."],
  earthflow:
  ...
  airkey:
    ["Ключ воздуха", 1, 1, "(воздух, диспел) Позволяет снять с противника баф земли или воды. Не забудьте выбрать цель."],
  airflow:
  ...
  lifespear:
    ["Касание жизни", 1, 1, "(жизнь, диспел) Позволяет снять дебаф смерти. Не забудьте выбрать цель."],
  lifeshild:
  ...
  lifekey:
    ["Ключ жизни", 1, 1, "(жизнь, диспел) Позволяет снять любой дебаф, срабатывает с вероятностью 66%. Не забудьте выбрать цель."],
  lifeflow:
  ...
  deathspear:
    ["Касание смерти", 1, 1, "(смерть, диспел) Позволяет снять любой баф с противника, срабатывает с вероятностью 66%. Не забудьте выбрать цель."],
  deathshild:
  ...
  deathpower:
    ["Власть смерти", 1, 1, "(смерть, диспел) Позволяет снять с противника баф жизни. Не забудьте выбрать цель."]
}
