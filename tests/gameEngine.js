...
describe('game engine', function () {
  ...
  describe('spells', function () {
    ...
    it('waterspear', function() {
      ...
      let enemyExpect = new Player(250, 250, [], []);
      enemyExpect.health = enemyExpect.health - waterspear.damage - 5;
    ...
    it('watershild', function() {
      ...
      spellExpect.damage = spellExpect.damage - Math.round(spellExpect.damage*40/100);;
    ...
    it('watercrown', function() {
      ...
      spellExpect.damage -= Math.round(spellExpect.damage*watercrown.percentDecreaseDamage/100);
    ...
    it('waterstamp', function() {
      ...
      spellExpect.damage = spellExpect.damage - Math.round(spellExpect.damage*33/100);;
    ...
    it('waterflow', function() {
      ...
      let enemyResult = new Player(250, 250, [], []);
      let enemyExpect = new Player(250, 250, [], []);
      enemyExpect.health -= waterflow.damage;
    ...
    it('earthspear', function() {
      ...
      let enemyResult = new Player(250, 250, [], []);
      let enemyExpect = new Player(250, 250, [], []);
      enemyExpect.health -= earthspear.damage;
    ...
    it('earthshild', function() {
      ...
      let totalDamage = (firespear.damage + firesource.damage) - 20;
      if (totalDamage < 0) totalDamage = 0;

      let playerExpect = new Player(250, 250, [], []);
      playerExpect.health = playerExpect.health - totalDamage;

      let playerResult = new Player(250, 250, [], []);
    ...
    it('earthstamp', function() {
      ...
      spellExpect.damage = spellExpect.damage - Math.round(spellExpect.damage*50/100);;
    ...
    it('earthflow', function() {
      ...
      let enemyResult = new Player(250, 250, [], []);
      let enemyExpect = new Player(250, 250, [], []);
      enemyExpect.health -= earthflow.damage;
    ...
    it('airspear', function() {
      ...
      let enemyResult = new Player(250, 250, [], []);
      let enemyExpect = new Player(250, 250, [], []);
      enemyExpect.health -= airspear.damage;
    ...
    it('airsphere', function() {
      ...
      let spellResult = new Firesource();
      spellResult.damage = spellExpect.damage;
    ...
    it('airflow', function() {
      ...
      let enemyResult = new Player(250, 250, [], []);
      let enemyExpect = new Player(250, 250, [], []);
      enemyExpect.health -= airflow.damage;
    ...
    it('lifesource', function() {
      ...
      let playerExpect = new Player(200, 250, [], []);
      playerExpect.health = 230;

      let playerResult = new Player(200, 250, [], []);
    ...
    it('deathkey', function() {
      ...
      let enemyExpect = new Player(1, 250, [], []);

      let enemyResult = new Player(20, 250, [], []);
    ...
    it('deathflow', function() {
      ...
      let user = new Player(200, 250, [], []);
      let enemy = new Player(210, 250, [], []);
